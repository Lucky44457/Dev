            ...
            async with aiofiles.open(file_path, mode="rb") as f:
                while True:
                    ...
                    try:
                        ...
                        try:
                log_chat = await app_client.get_chat(LOG_GROUP)
                src_chat = await app_client.get_chat(msg.chat.username or msg.chat.id)
                ...
                await app_client.send_message(LOG_GROUP, f"⚠️ Public copy failed: {e}")
